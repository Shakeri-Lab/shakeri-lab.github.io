...
export const news: NewsItem[] = [
  {
    date: "August 2026",
    title: "Invited Lecture at ATTD 2027 in Paris",
    content: "The Organizing Committee of the 20th International Conference on Advanced Technologies and Treatments for Diabetes (ATTD 2027) has invited Dr. Shakeri to deliver a lecture on 'Using CGM and AI for Early Detection of Diabetes.' The conference will be held in Paris, France, March 3-6, 2027. The talk will open a session on Advancing Diabetes Care Through Artificial Intelligence, a session proposed by Dr. Shakeri and adopted by the committee for the conference program.",
    links: [{
      text: "ATTD 2027",
  ...
  },
  {
    ...
    content: "The lab will present two abstracts at the 2025 ARVO Annual Meeting (May 4-8): 'An Automated Pipeline for Converting Unstructured Clinical Text to Standardized Measurements,' and 'Identification of Visual Impairment Risk Factors in Southwest Virginia'.",
    links: [{
  ...
  // 2024
  {
    ...
    content: "Our work on 'Deep Reinforcement Learning Bolus Priming for Intelligent Prandial Management' has been accepted for presentation at the 18th International Conference on Advanced Technologies & Treatments for Diabetes (ATTD 2025) in Amsterdam, The Netherlands, March 19-22, 2025.",
    links: [{
      text: "Conference Website",
  ...
  },
  {
    ...
    content: "Shakeri Lab received a $200k grant from LaunchPad for Diabetes to pilot trial the use of advanced ML tools in Artificial Pancreas technology. The program supports innovative solutions for Type 1 or Type 2 diabetes treatment, focusing on translational research projects that address unmet clinical needs.",
    links: [{
      text: "Learn More",
  ...
  {
    date: "2022",
    title: "Preprint: Cortical Metastability",
